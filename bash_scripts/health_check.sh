...
STUDENTS_STATUS=$(curl -s -o /dev/null -w "%{http_code}" http://13.61.18.76:5000/students)
SUBJECTS_STATUS=$(curl -s -o /dev/null -w "%{http_code}" http://13.61.18.76:5000/subjects)
